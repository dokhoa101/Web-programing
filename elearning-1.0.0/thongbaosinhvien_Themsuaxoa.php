        ...
        <div class="container-fluid">
            <div class=" row">
                ...
                <div class="col-md-10 col-sd-10">
                    <div class="row">
                        <div class="pt-3">
                            <form action="./thongbao_them.php" method="post" enctype="multipart/form-data">
                                <div class="form-group my-2">
                                    <label for="title">Title</label>
                                    <textarea id="Title" name="title" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="noidung">Content</label>
                                    <textarea id="noidung" name="noidung" class="form-control textarea"></textarea>
                                </div>
                    ...
                    <div class="row">
                        <div class="">
                            ...
                            try {
                                ...
                                $stmt = $conn->prepare("SELECT * FROM thongbaosv ORDER BY maTB ASC LIMIT {$item_per_page} OFFSET {$offset}");
                                $stmt->execute();
                                $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                $dulieu_thongbao = $stmt->fetchAll();

                                $stmt = $conn->prepare("SELECT * FROM thongbaosv ");
                                $stmt->execute();
                                $stmt->setFetchMode(PDO::FETCH_ASSOC);
                            ...
                            <div class="table-responsive" style="max-width: fit-content;max-height:min-content;">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        if (isset($dulieu_thongbao)) {
                                            foreach ($dulieu_thongbao as $dulieu) {
                                                ...
                                                echo '
                <tr>
                    <td><div class="limited-height">' . $dulieu['MaTB'] . '</div></td>
                    <td><div class="limited-height">' . $dulieu['titleTB'] . '</div></td>
                    <td><div class="limited-height">' . $dulieu['NoiDung'] . '</div></td>
