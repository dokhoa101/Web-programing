        ...
        <div class="container-fluid">
            <div class=" row">
                ...
                <div class="col-md-10 col-sd-10">
                    <div class="row">
                        <div class="pt-3">
                            <form action="./vieclam_them.php" method="post" enctype="multipart/form-data">
                                <div class="form-group my-2">
                                    <label for="vitri">Vị trí</label>
                                    <textarea id="vitri" name="vitri" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="luong">Lương</label>
                                    <textarea id="luong" name="luong" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="ten">Tên công ty</label>
                                    <textarea id="ten" name="ten" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="yeucau">Yêu cầu</label>
                                    <textarea id="yeucau" name="yeucau" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="gioithieu">Giới thiệu</label>
                                    <textarea id="gioithieu" name="gioithieu" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="img">Link ảnh</label>
                                    <textarea id="img" type="text" name="img" class="form-control textarea"></textarea>
                                </div>

                                <div class="form-group my-2">
                                    <label for="time">Thời gian</label>
                                    <input type="date" id="time" name="time" class="form-control datepicker">
                                </div>
                    ...
                    <div class="row">
                        <div class="">
                            ...
                            try {
                                ...
                                $stmt = $conn->prepare("SELECT * FROM thongtinvieclam ORDER BY maso ASC LIMIT {$item_per_page} OFFSET {$offset}");
                                $stmt->execute();
                                $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                $dulieus = $stmt->fetchAll();

                                $stmt = $conn->prepare("SELECT * FROM thongtinvieclam ");
                                $stmt->execute();
                                $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($dulieus)) {
                                            foreach ($dulieus as $dulieu) {
                                                ...
                                                echo '
                                        <tr>
                                            <td><div class="limited-height">' . $dulieu['maso'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['vitri'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['luong'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['anhcongty'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['tencongty'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['yeucau'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['gioithieucongty'] . '</div></td>
                                            <td><div class="limited-height">' . $dulieu['time'] . '</div></td>
                                            <td>' . $sua . '</td>
                                            <td>' . $xoa . '</td>
                                        </tr>
                                            ';
