                            ...
                            <div class="block-body">
                                <form class="form-inline" action="{{url('add_category')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="category" class="sr-only">Add Category</label>
                                        <input id="category" name="category" type="text" placeholder="" class="mr-sm-3 form-control">
                                    </div>
                                    <div class="form-group">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('delete_category',$data->id)}}" class="btn btn-danger" onclick="return confirmDelete(event, this)">Delete</a></td>
                                    </tr>
                                    @endforeach
